...
public class T5Drop : MonoBehaviour, IDropHandler
{
    private T5Manager REF_DragnDrop_V1;
    ...
    void Start()
    {
        REF_DragnDrop_V1 = FindObjectOfType<T5Manager>();
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (drag.name == gameObject.name)
        {
            ...
            T5Manager.instance.ReportCorrectAnswer(drag.name);
        ...
        else
        {
            ...
            T5Manager.instance.ReportWrongAnswer(drag.name);
