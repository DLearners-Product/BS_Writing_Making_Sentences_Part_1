...
{
    private T8Managaer REF_DragnDrop_V1;
    ...
    void Start()
    {
        REF_DragnDrop_V1 = FindObjectOfType<T8Managaer>();
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (drag.name == gameObject.name)
        {
            ...
            T8Managaer.instance.ReportCorrectAnswer(drag.name);
        ...
        else
        {
            ...
            T8Managaer.instance.ReportWrongAnswer(drag.name);
